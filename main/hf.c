...
void SymmetryA(double *n, double *m) {n[0] = n[2];        m[0] = m[2];}
void SymmetryC(double *n, double *m) {n[1] = n[2];        m[1] = m[2];}
void SymmetryG(double *n, double *m) {n[0] = n[1] = n[2]; m[0] = m[1] = m[2];}
